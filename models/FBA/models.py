...
import models.FBA.resnet_GN_WS as resnet_GN_WS
import models.FBA.layers_WS as L
import models.FBA.resnet_bn as resnet_bn
...
class MattingModule(nn.Module):
    ...
    #     conv_out, indices = self.encoder(resnet_input)
