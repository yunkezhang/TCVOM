...
from models.GCA.encoders.resnet_enc import ResNet_D
from models.GCA.ops import GuidedCxtAtten, SpectralNorm
from models.GCA import TRIMAP_CHANNEL
...
class ResGuidedCxtAtten(ResNet_D):
    ...
    def forward(self, x):
        ...
        if TRIMAP_CHANNEL == 3:
            ...
            unknown = F.interpolate(x[:,3:,...].eq(1.).float(), scale_factor=1/8, mode='nearest', recompute_scale_factor=True)
